...
if __name__ == "__main__":
    ...
    parser.add_argument("--word-vectors-path", "-wv",
                        ...
                        help="path to word vectors file", default='word_vectors/listings.w2v')

    parser.add_argument("--batch-size", "-b", dest="batch_size", type=int, default=50,
                        help="Batch size for training")

    parser.add_argument("--aspects-number", "-as", dest="aspects_number", type=int, default=9,
    ...
    parser.add_argument("--epochs", "-e", dest="epochs", type=int, default=15,
                        help="Epochs count")
    ...
    parser.add_argument("--dataset-path", "-d", dest="dataset_path", type=str, default="preprocessed_data/listings.txt",
